...
def testing():
   pytest.driver = webdriver.Chrome('C:/Users/kiril/PycharmProjects/pythonProject8/chromedriver.exe')
...
def test_name_age_of_pets():
   # Вводим email
   pytest.driver.find_element(By.ID, "email").send_keys('tsykir123@mail.ru')
   # Вводим пароль
